<head>
 ...
 {{-- <head>
    ...
    <!-- Local CSS -->
    <link href="{{ secure_asset('css/Member.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ secure_asset('plugins/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css" />
