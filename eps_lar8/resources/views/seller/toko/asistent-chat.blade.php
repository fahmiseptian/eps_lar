...
<body>
    ...
    <script>
        ...
        $('.item-box-filter-pesanan[data-tipe="a_chat"]').addClass("open");
        $('.item-box-filter-pesanan[data-tipe="a_chat"]').addClass("active");
        activeItem = $('.item-box-filter-pesanan[data-tipe="a_chat"]');
        allItems.slideUp();
