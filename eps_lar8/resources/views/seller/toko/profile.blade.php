...
<body>
    <div class="container-fluid">
        ...
        <script>
            ...
            $('.item-box-filter-pesanan[data-tipe="profile"]').addClass("open");
            $('.item-box-filter-pesanan[data-tipe="profile"]').addClass("active");
            activeItem = $('.item-box-filter-pesanan[data-tipe="profile"]');
            allItems.slideUp();
