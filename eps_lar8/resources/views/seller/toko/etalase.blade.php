...
<body>
    <div class="container-fluid">
        ...
        <script>
            ...
            $('.item-box-filter-pesanan[data-tipe="etalase"]').addClass("open");
            $('.item-box-filter-pesanan[data-tipe="etalase"]').addClass("active");
            activeItem = $('.item-box-filter-pesanan[data-tipe="etalase"]');
            allItems.slideUp();
