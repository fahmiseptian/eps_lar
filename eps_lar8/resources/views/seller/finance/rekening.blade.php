...
<body>
    ...
    <script>
        ...
        $('.item-box-filter-pesanan[data-tipe="rekening"]').addClass("open");
        $('.item-box-filter-pesanan[data-tipe="rekening"]').addClass("active");
        activeItem = $('.item-box-filter-pesanan[data-tipe="rekening"]');
        allItems.slideUp();
