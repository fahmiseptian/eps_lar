                        ...
                        <div class="box box-info">
                            <div class="box-body">
                                <div class="filter-links">
                                    ...
                                    <a href="javascript:;" data-status-order="waiting_accept_order" onclick="toggleFilterorder(this)">Perlu Dikemas</a>
                                    <a href="javascript:;" data-status-order="on_packing_process" onclick="toggleFilterorder(this)">Perlu Dikirim</a>
                                    <a href="javascript:;" data-status-order="send_by_seller" onclick="toggleFilterorder(this)">Dikirim</a>
                                    <a href="javascript:;" data-status-order="complete" onclick="toggleFilterorder(this)">Pesanan Diterima</a>
                                    <a href="javascript:;" data-status-order="done" onclick="toggleFilterorder(this)">Selesai</a>
                                    <a href="javascript:;" data-status-order="cancel_by_seller" onclick="toggleFilterorder(this)">Dibatalkan</a>
