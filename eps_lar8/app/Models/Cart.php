    ...
    function getRates($id_cart, $id_shop) {
        $data = DB::table('shop_courier as sc')
            ->select([
                ...
                DB::raw("(SELECT ma.subdistrict_id FROM cart LEFT JOIN member_address ma ON ma.member_address_id = cart.id_address_user WHERE cart.id = 598) as id_subdistrict_dest"),
